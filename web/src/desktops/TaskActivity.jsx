...
const WORDS = {
  ...
  'task.waiting': (payload) => payload.detail || 'Waiting for a free workspace',
  'task.retried': () => 'Asked again, as a new task',
  'queue.blocked': (payload) => `Nothing else will start: ${payload.reason}`,
  'queue.resumed': () => 'Carrying on with what is queued',
  'control.expired': (payload) => payload.detail || 'Control went back to nobody',
